...
colnames(x2) <- vectorn
rownames(x2) <- seq(1:(replica*2))

plot(x2[1:30,1],  type = "l", main = "16,000 part�culas (C Menor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[1:30,2],  type = "l", main = "32,000 part�culas (C Menor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[1:30,3],  type = "l", main = "64,000 part�culas (C Menor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[1:30,4],  type = "l", main = "128,000 part�culas (C Menor)", xlab = "Repeticiones", ylab="Iteraci�n") 

plot(x2[31:60,1],  type = "l", main = "16,000 part�culas (C Mayor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[31:60,2],  type = "l", main = "32,000 part�culas (C Mayor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[31:60,3],  type = "l", main = "64,000 part�culas (C Mayor)", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[31:60,4],  type = "l", main = "128,000 part�culas (C Mayor)", xlab = "Repeticiones", ylab="Iteraci�n") 
