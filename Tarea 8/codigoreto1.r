...
plot(x2[,1], type = "l", main = "16,000 part�culas", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[,2], type = "l", main = "32,000 part�culas", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[,3], type = "l", main = "64,000 part�culas", xlab = "Repeticiones", ylab="Iteraci�n")
plot(x2[,4], type = "l", main = "128,000 part�culas", xlab = "Repeticiones", ylab="Iteraci�n")
