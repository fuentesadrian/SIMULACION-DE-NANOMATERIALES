...
png("p4_semillas80.png")
lbls = c("40", "50", "60", "70", "80", "90", "100")
install.packages("vioplot")
library("vioplot")
vioplot(zona40, zona50, zona60, zona70, zona80, zona90, zona100, col=c(20,7,19, 64, 98, 53, 30), names = lbls, ylab="Tamaño de zona", xlab="Longitud de grieta (manhattan)", ylim = c(1, 1400), horizontal=TRUE )
graphics.off()
